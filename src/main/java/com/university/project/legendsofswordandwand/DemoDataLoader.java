 ...
 *
 * <p>Creates two users (player1 and player2) each with saved parties containing heroes at various
 * levels and hybrid classes, suitable for immediately testing all use cases including PvP without
 * manual setup.
 */
@Component
@Profile("demo")
...
public class DemoDataLoader implements CommandLineRunner {
  ...
  /**
   * Adds a hero directly with preset stats to the party, bypassing the normal level-up flow so we
   * can set exact levels and hybrid classes for demo purposes.
   */
