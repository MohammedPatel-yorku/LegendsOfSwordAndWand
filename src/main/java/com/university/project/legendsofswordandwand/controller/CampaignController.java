...
public class CampaignController {
    ...
    /**
     * Serves the main campaign page, populating the model with the current room, heroes,
     * gold, inventory, and any heroes with a pending level-up.
     *
     ...
     *
     * <p>Prevents exit if a battle room is currently pending, adding an error flash attribute
     * and redirecting back to the campaign page in that case.
     *
     * @param authentication     the current user's authentication
     ...
     *
     * <p>Redirects to the page specified by {@code returnTo} after the level-up,
     * defaulting to {@code /campaign}.
     *
     * @param authentication     the current user's authentication
