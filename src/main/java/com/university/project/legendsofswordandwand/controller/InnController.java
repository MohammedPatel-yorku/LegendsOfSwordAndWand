...
public class InnController {
  ...
  private void populateInnModel(
      Model model, Campaign campaign, List<Hero> recruits, HttpSession session) {
    ...
    model.addAttribute(
        "heroes", campaign.getParty().getHeroes().stream().filter(h -> !h.isTemporary()).toList());
