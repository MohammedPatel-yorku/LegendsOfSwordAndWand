...
/**
 * Spring component responsible for calculating and applying stat changes to a {@link Hero}
 * upon levelling up or class promotion.
 *
 * <p>Delegates class-specific stat bonuses to the appropriate {@link ClassBonusStrategy},
 * and resolves hybrid class assignments via {@link HybridClassResolver}.
 */
@Component
...
public class HeroStatCalculator {
     ...
     *
     * <ul>
     *   <li>Hybrid heroes receive one bonus application from each of their two classes.</li>
     *   <li>Heroes whose primary class matches {@code heroClass} receive the class bonus twice.</li>
     *   <li>All other heroes receive the class bonus once.</li>
     * </ul>
     *
    ...
    /**
     * Applies only the class bonus for the given {@link HeroClass} to the hero, without
     * incrementing their level or applying base stat gains.
     *
     ...
     *
     * <p>The threshold grows quadratically: each level adds {@code 500 + 75*level + 20*level²}
    ...
    /**
     * Applies the base stat gains for a level-up, incrementing level, attack, defense,
     * health, max health, mana, and max mana by fixed amounts.
     *
    ...
    /**
     * Applies the level bonus for the given {@link HeroClass} to the hero by delegating
     * to the matching {@link ClassBonusStrategy}.
     *
     * @param hero      the {@link Hero} to apply the bonus to
