 ...
 *
 * <p>Each unshielded ally receives a shield worth 10% of their maximum health. {@code PROPHET}
 * doubles the shield amount. Allies that are already shielded are unaffected.
 */
public class ProtectAbility implements Ability {
   ...
   *
   * <p>Each ally without an existing shield receives a shield equal to 10% of their maximum health,
   * doubled if the caster's {@link HybridClass} is {@code PROPHET}. Allies that already have a
   * shield active are skipped. Each outcome is logged to the {@link BattleState}.
   *
