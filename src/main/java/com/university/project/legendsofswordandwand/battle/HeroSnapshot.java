 ...
 *
 * <p>Decouples battle logic from the persistent {@link Hero} entity, allowing stats
 * to be mutated freely during combat without affecting the underlying model until
 * results are explicitly written back. Implements {@link Serializable} to support
 * session persistence.
 */
@Getter
@Setter
