...
/**
 * Spring component responsible for executing hero abilities and applying
 * passive combat effects during battle.
 *
 * <p>Delegates ability construction to {@link AbilityFactory} and damage
 * application to {@link AbilityHelper}.
 */
@Component
...
public class AbilityExecutor {
     ...
     * otherwise falling back to their starting class. The resolved {@link Ability} is then
     * executed after deducting its mana cost from the caster.
     *
     * @param caster       the {@link BattleUnit} casting the ability
     * @param target       the primary target {@link BattleUnit}, may be {@code null} for untargeted abilities
     ...
     *
     * <p>Has a 50% chance of triggering. If it triggers, deals bonus damage equal to
     * half of the standard calculated damage between the two units.
     *
