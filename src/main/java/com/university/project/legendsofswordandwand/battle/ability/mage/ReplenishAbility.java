 ...
 *
 * <p>The {@code PROPHET} hybrid class doubles all restore amounts. The {@code WIZARD}
 * hybrid class benefits from a reduced mana cost to cast this ability.
 */
public class ReplenishAbility implements Ability {
     ...
     *
     * <p>Each ally receives {@code 30} mana, while the caster receives {@code 60} mana.
     * Both values are doubled if the caster's {@link HybridClass} is {@code PROPHET}.
     * Mana is capped at each hero's maximum. Each restore is logged to the {@link BattleState}.
     *
