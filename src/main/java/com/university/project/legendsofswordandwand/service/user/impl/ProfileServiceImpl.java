...
/**
 * Default implementation of {@link IProfileService}, assembling user profile data
 * and hall of fame rankings.
 */
@Service
...
class ProfileServiceImpl implements IProfileService {
     ...
     *
     * <p>Includes the username, PvP record, all saved party summaries, and a history
     * of campaign results ordered by score descending.
     *
     ...
     *
     * <p>Each entry includes the rank, owner's username, score, rooms completed, permanent
     * hero count, cumulative party level, and gold held at the end of the campaign.
     *
