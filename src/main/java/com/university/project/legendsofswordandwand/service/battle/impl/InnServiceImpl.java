...
/**
 * Default implementation of {@link IInnService}, handling inn visit logic including
 * party healing, shop purchases, hero recruitment, and temporary recruit cleanup.
 */
@Service
@Transactional
...
class InnServiceImpl implements IInnService {
     ...
     *
     * <p>Recruits are only available within the first 10 rooms and when the party has fewer
     * than 5 permanent heroes. Between 1 and 3 recruits are generated with random classes and
     * levels between 1 and 4. Stats are computed by applying level-up and class bonus logic.
     * All recruits are marked as temporary and saved to the database.
     *
     ...
     * @return {@code true} if the purchase succeeded, {@code false} if the party had insufficient gold
     ...
     *
     * <p>Level 1 recruits are free. Higher-level recruits cost {@code (level - 1) * 200} gold.
     * The hero is marked as permanent before saving to ensure they survive the next cleanup.
     *
     ...
     *
     * <p>Should be called at the end of each inn visit to remove heroes the player chose not to recruit.
     *
