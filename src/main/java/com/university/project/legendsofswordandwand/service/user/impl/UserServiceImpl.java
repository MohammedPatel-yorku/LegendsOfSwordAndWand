...
class UserServiceImpl implements IUserService {
     ...
     *
     * <p>If the user has an active campaign, the dashboard reflects that campaign's party stats.
     * If the user has no active campaign but has a saved party, the most recently saved party's
     * stats are shown instead. Party size counts only permanent (non-temporary) heroes.
     *
