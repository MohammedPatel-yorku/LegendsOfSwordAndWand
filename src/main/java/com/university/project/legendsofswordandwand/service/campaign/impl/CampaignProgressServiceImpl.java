...
/**
 * Default implementation of {@link ICampaignProgressService}, managing room progression,
 * campaign completion checks, score calculation, and view data assembly.
 */
@Service
@Transactional
...
class CampaignProgressServiceImpl implements ICampaignProgressService {
     ...
     *
     * <p>If a room is already pending (i.e. the player has entered but not completed it),
     * the same room type is returned without advancing. Otherwise, a new room type is randomly
     * determined: the chance of a battle room scales with the party's cumulative level,
     * starting at 60% and capping at 90%. Inn rooms mark {@code hasVisitedInn} as true.
     *
     ...
     *
     * <p>Retrieves the most recently completed campaign for the user and includes its score,
     * gold, permanent heroes, and the player's existing saved parties.
     *
     * @param username the username of the player
