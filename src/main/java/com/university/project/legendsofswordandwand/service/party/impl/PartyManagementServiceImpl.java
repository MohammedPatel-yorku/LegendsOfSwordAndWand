...
/**
 * Default implementation of {@link IPartyManagementService}, handling party retrieval,
 * healing, gold management, and hero roster changes.
 */
@Service
@Transactional
...
class PartyManagementServiceImpl implements IPartyManagementService {
     ...
     *
     * <p>For each permanent hero: if they were dead, a revival message is added; if they gained
     * HP or mana, the amounts restored are described; if they were already at full health,
     * that is noted. Temporary heroes are excluded from healing and the summary.
     *
     * @param campaignId the ID of the campaign whose party to heal
